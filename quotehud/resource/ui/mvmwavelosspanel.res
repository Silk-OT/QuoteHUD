"Resource/UI/MvMWaveLossPanel.res"
{
	...
	"PanelBackground"
	{
		...
		"bgcolor_override" "quoteblack"
		//only edit here for windows when it comes to loss also replace tandarker with 235 226 202 255, replace black with it as well but make sure not
		//to do replace all, replace manually. Also fix credit collection and use tall as I do
	}
